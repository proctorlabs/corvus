...
HassPayload! {
    ...
    device:HassDeviceInformation => "dev" "device",
    ...
    payload_high_speed:String => "pl_hi_spd" "payload_high_speed",
    ...
    payload_low_speed:String => "pl_lo_spd" "payload_low_speed",
    payload_medium_speed:String => "pl_med_spd" "payload_medium_speed",
    ...
    payload_off_speed:String => "pl_off_spd" "payload_off_speed",
    ...
    speed_command_topic:String => "spd_cmd_t" "speed_command_topic",
    speed_state_topic:String => "spd_stat_t" "speed_state_topic",
    speed_value_template:String => "spd_val_tpl" "speed_value_template",
    speeds:String => "spds" "speeds",
